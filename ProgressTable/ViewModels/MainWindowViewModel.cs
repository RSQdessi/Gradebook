...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Звягинцев Михаил Евгеньевич", Visual=2, Architecture=2, Networks=2, Calculate_Math=1, PI=2, Math=2, Electric=2},
                new Student{Name="КУзьменок Денис Витальевич", Visual=1, Architecture=0, Networks=0, Calculate_Math=1, PI=2, Math=1, Electric=2},
            };
            CheckAverage(students);
